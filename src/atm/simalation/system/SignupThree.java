...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        pindetail.setFont(new Font("Raleway",Font.BOLD,20));
    ...
    public void actionPerformed(ActionEvent ae){
        String acountType = null;
        if(r1.isSelected()){ 
            acountType = "Saving Account";
        }
        else if(r2.isSelected()){ 
            acountType = "Fixed Deposit Account";
        }
        ...
        try{
            if(ae.getSource()==submit){
                ...
                if(acountType.equals("")){
                    ...
                    Conn c1 = new Conn();
                    String q1 = "insert into signupthree values('"+formno+"','"+acountType+"','"+cardnumber+"','"+pin+"','"+facility+"')";  
